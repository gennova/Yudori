 ...
 * Program Intentity :
 * Code Name  :
 * Code Created on Jan 6, 2012, 8:30:07 AM
 * @author PresdirTendy
 */
public class PanelBackgroundHome extends JPanel{

    private Image image;

    public PanelBackgroundHome() {
        setOpaque(false);
        image = new ImageIcon(getClass().getResource("/Code/Name/Flamboyan/Files/logo sadhar.png")).getImage();
    }
