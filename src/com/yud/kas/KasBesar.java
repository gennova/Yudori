 ...
 * @author legollas
 */
public class KasBesar {

    private int idKas;
    private String kodeKas;
    private String kodeManKas;
    ...
    public void setIdKas(int idKas) {
        this.idKas = idKas;
    }
    ...
    public String getKodeManKas() {
        return kodeManKas;
    }

    public void setKodeManKas(String kodeManKas) {
        this.kodeManKas = kodeManKas;
    }
