 ...
 * @author legollas
 */
public class KomisiTabelModelSalesTUNAI extends AbstractTableModel {

    private List<Komisi> Lists;

    public KomisiTabelModelSalesTUNAI(List<Komisi> Lists) {
        this.Lists = Lists;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 5:
                return Lists.get(rowIndex).getKomdisitunai();
            case 6:
                return Lists.get(rowIndex).getRpkomisitunai();
            case 7:
                return Lists.get(rowIndex).getStatuskomisitunasi();
            default:
                return null;
        }
    }
