 ...
 * @author legollas
 */
public class KomisiTabelModelSalesBpRekap extends AbstractTableModel {

    private List<Komisi> Lists;

    public KomisiTabelModelSalesBpRekap(List<Komisi> Lists) {
        this.Lists = Lists;
    }
