 ...
 * @author legollas
 */
public class KomisiTabelModelSalesBp extends AbstractTableModel {

    private List<Komisi> Lists;

    public KomisiTabelModelSalesBp(List<Komisi> Lists) {
        this.Lists = Lists;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 5:
                return Lists.get(rowIndex).getKomisibp();
            case 6:
                return Lists.get(rowIndex).getRpkomisibp();
            case 7:
                return Lists.get(rowIndex).getStatuskomisibp();
            default:
                return null;
        }
    }
