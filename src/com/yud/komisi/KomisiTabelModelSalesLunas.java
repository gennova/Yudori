 ...
 * @author legollas
 */
public class KomisiTabelModelSalesLunas extends AbstractTableModel {

    private List<Komisi> Lists;

    public KomisiTabelModelSalesLunas(List<Komisi> Lists) {
        this.Lists = Lists;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 5:
                return Lists.get(rowIndex).getKomisilunas();
            case 6:
                return Lists.get(rowIndex).getRpkomisilunas();
            case 7:
                return Lists.get(rowIndex).getStatuskomisilunas();
            default:
                return null;
        }
    }
