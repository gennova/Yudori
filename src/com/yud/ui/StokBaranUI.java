 ...
 * @author legollas
 */
public class StokBaranUI extends javax.swing.JFrame {
    ...
    private void showbarang() {
        StokTabelModel model = new StokTabelModel(DaoFactory.getStokDao().getAllStokBarang());
    ...
    private void initComponents() {
        ...
        jButton2.setText("Cetak Laporan Stok");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new PrintReport("./report/stokbarang.jasper", "","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StokBaranUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StokBaranUI().setVisible(true);
            }
        });
    }
