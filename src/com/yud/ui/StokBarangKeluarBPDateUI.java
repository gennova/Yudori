 ...
 * @author legollas
 */
public class StokBarangKeluarBPDateUI extends javax.swing.JFrame {
     ...
     */
    public StokBarangKeluarBPDateUI() {
        initComponents();
    ...
    private void showbarang(String date) {
        StokTabelModel model = new StokTabelModel(DaoFactory.getStokDao().getLaporanPengeluanBarangByDate(date));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StokBarangKeluarBPDateUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StokBarangKeluarBPDateUI().setVisible(true);
            }
        });
    }
