...
public class BPHarianUIDROPA1 extends javax.swing.JFrame {
    ...
    private void showbuktipesanan(String date) {
        BuktiPesananTabelModel bptab = new BuktiPesananTabelModel(DaoFactory.getBuktiPesananDao().getAllBuktiPesananByDateDROPA1(date));
    ...
    private void initComponents() {
        ...
        jLabel18.setText("DAFTAR BUKTI PESANAN DROP A1 HARIAN");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        new PrintReport("./report/buktipesananhariandropa1.jasper", "tglpesananparams", df.format(tglAwal.getDate()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BPHarianUIDROPA1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BPHarianUIDROPA1().setVisible(true);
            }
        });
    }
