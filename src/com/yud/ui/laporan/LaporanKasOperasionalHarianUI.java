 ...
 * @author amnesia
 */
public class LaporanKasOperasionalHarianUI extends javax.swing.JFrame {

    /**
     * Creates new form LaporanKasOperasionalHarianUI
     */
    public LaporanKasOperasionalHarianUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LAPORAN KAS OPERASIONAL HARIAN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        KasTabelModelLapTrx kbtm = new KasTabelModelLapTrx(DaoFactory.getKasDao().getALlKasByDate(tgl));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanKasOperasionalHarianUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanKasOperasionalHarianUI().setVisible(true);
            }
        });
    }
