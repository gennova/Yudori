...
public class BPHarianUITUNAI extends javax.swing.JFrame {
    ...
    private void showbuktipesanan(String date) {
        BuktiPesananTabelModel bptab = new BuktiPesananTabelModel(DaoFactory.getBuktiPesananDao().getAllBuktiPesananByDateTUNAI(date));
    ...
    private void initComponents() {
        ...
        jLabel18.setText("DAFTAR BUKTI PESANAN TUNAI HARIAN");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        new PrintReport("./report/buktipesananhariantunai.jasper", "tglpesananparams", df.format(tglAwal.getDate()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BPHarianUITUNAI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BPHarianUITUNAI().setVisible(true);
            }
        });
    }
