 ...
 * @author legollas
 */
public class AngsuranBulananLapBulananUI extends javax.swing.JFrame {
     ...
     */
    public AngsuranBulananLapBulananUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DAFTAR ANGSURAN PER BULAN");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(tglAwal, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(27, 27, 27)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tanggalnya = df.format(tglAwal.getDate());
        String tanggalnya2 = df.format(tglAKhir.getDate());
        showAngsuranBP(tanggalnya,tanggalnya2);
        txtTotal.setText(String.valueOf(DaoFactory.getAngsuranBulananDao().getSUMAllAngsuranBulananByTglBulanan(tanggalnya, tanggalnya2)));
    ...
    private void showAngsuranBP(String tgl,String tgl2) {
        AngsuranBulananTabelModelNama bptm = new AngsuranBulananTabelModelNama(DaoFactory.getAngsuranBulananDao().getAllAngsuranBulananByTglBulanan(tgl, tgl2));
        sorter2 = new TableRowSorter<TableModel>(bptm);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AngsuranBulananLapBulananUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AngsuranBulananLapBulananUI().setVisible(true);
            }
        });
    }
