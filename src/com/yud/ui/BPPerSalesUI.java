 ...
 * @author legollas
 */
public class BPPerSalesUI extends javax.swing.JFrame {
    ...
    private void loadsales(){
        comboSales.removeAllItems();
        List<Sales> salesnya = DaoFactory.getSalesDao().getAllSales();
        for (int i = 0; i < salesnya.size(); i++) {
            comboSales.addItem(salesnya.get(i).getnamaSales());
        }
    }
    private void showbuktipesanan(int kode) {
        BuktiPesananTabelModel bptab = new BuktiPesananTabelModel(DaoFactory.getBuktiPesananDao().getAllBuktiPesananBySales(kode));
    ...
    private void initComponents() {
        ...
        comboSales.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(comboSales, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(comboSales, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String namanyasales = comboSales.getSelectedItem().toString();
        Sales sales = DaoFactory.getSalesDao().getSalesByName(namanyasales);
        showbuktipesanan(sales.getidSales());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BPPerSalesUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BPPerSalesUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> comboSales;
