...
public class BPHarianUIINDET extends javax.swing.JFrame {
    ...
    private void showbuktipesanan(String date) {
        BuktiPesananTabelModel bptab = new BuktiPesananTabelModel(DaoFactory.getBuktiPesananDao().getAllBuktiPesananByDateINDENT(date));
    ...
    private void initComponents() {
        ...
        jLabel18.setText("DAFTAR BUKTI PESANAN INDENT HARIAN");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addComponent(jLabel18, javax.swing.GroupLayout.DEFAULT_SIZE, 1110, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        new PrintReport("./report/buktipesananharianindent.jasper", "tglpesananparams", df.format(tglAwal.getDate()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BPHarianUIINDET.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BPHarianUIINDET().setVisible(true);
            }
        });
    }
