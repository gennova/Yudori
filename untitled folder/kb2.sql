...
DROP PROCEDURE IF EXISTS `spCetakLaporanKasBesarBulanan2`$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `spCetakLaporanKasBesarBulanan2`(IN tanggalnya VARCHAR(100), IN tanggalnyaakhir VARCHAR(100))
BEGIN
