...
insert  into `angsuran`(`id`,`kodeangsuran`,`kodebp`,`idpelanggan`,`pembayar`,`jumlah`,`penerima`,`tanggal`,`keterangan`,`timestamp`,`akun`,`dk`) values (1,'KA0908170001','BP010817001',8,'Bu Mimin',129000,'Ayu Admin','2017-04-08','','2017-08-09 15:26:47','11510201','K');
...
insert  into `barang`(`idbarang`,`namabarang`,`idharga`) values (1,'Yudori Noodles Maker',1),(2,'Yudori Alsyva',2),(3,'Yudori 8 Pcs Fancy Set',3),(4,'Yudori 8 Pcs Tulip Set',4),(5,'Yudori Blender Ez Blend',5),(6,'Yudori Chopper 1.8 L',6),(7,'Yudori Griddle 2 in 1',7),(8,'Yudori Chopper 1.8 L + Yudori Noodle Maker',8),(9,'Yudori Chopper 1.8 L + Yudori 8 Pcs Fancy set',9),(10,'Yudori Chopper 1.8 L + Yudori 8 Pcs Tulip set',10),(11,'Yudori Ez Blender + Yudori Gridle 2 in 1',11),(12,'Yudori Chopper 1.8 L + Yudori Griddle 2 in 1',12),(14,'Yudori Griddle 2 in 1 + Alsyva',14),(15,'Yudori Chopper 1.8 L + Alsyva',15);
...
insert  into `buktipesanan`(`idpesanan`,`kodebp`,`idpesananfaktur`,`namapelanggan`,`alamatpelanggan`,`telepon`,`idsales`,`komisisales`,`jenisorder`,`tglpesanan`,`tglpenagihan`,`tglpengiriman`,`total`,`UM`,`sisa`,`sisaberjalan`,`idpelanggan`,`timestamp`,`statusbp`,`angsuran`,`hargatunai`,`statuskirim`) values (1,'BP010817001','009493','Bu Mimin','MA Al Ashor','081575098081',6,1,'DROP A1','2017-04-08','2017-05-17','2017-04-08',929000,129000,8,2,7,'2017-08-01 15:34:33','belum','100000',0,'belum');
...
insert  into `detailangsuran`(`id`,`noans`,`nobp`,`tgl`,`angsuranke`,`jumlah`) values (1,'KA0908170001','BP010817001','2017-05-17','Angsuran 1',100000),(2,'KA0908170001','BP010817001','2017-06-07','Angsuran 2',100000);
...
insert  into `detailpesanan`(`idorder`,`kodebarang`,`namabarang`,`unit`,`harga`,`total`,`idpesanan`,`kodebp`,`idpelanggan`) values (1,6,'Yudori Chopper 1.8 L',1,929000,929000,1,'BP010817001',7);
...
insert  into `hargabarang`(`idharga`,`idbarang`,`hargatunai`,`hargadrop`,`hargaindent`,`UM`,`hargapromositunai`,`tanggal`,`sisa`,`sisa1`,`sisa2`,`tglberlakumulai`,`tglberlakuakhir`,`aktif`) values (1,1,2500000,2939000,2760000,329000,2500000,'',0,9,290000,'2017-04-25','2017-10-31','Y'),(2,2,1580000,1584000,1580000,189000,1580000,'',0,9,155000,'2017-04-25','2017-10-31','Y'),(3,3,1050000,1239000,1125000,159000,1050000,'',0,9,120000,'2017-04-25','2017-10-31','Y'),(4,4,1250000,1429000,1300000,169000,1250000,'',0,9,140000,'2017-04-25','2017-10-31','Y'),(5,5,990000,1099000,1050000,139000,990000,'',0,8,120000,'2017-04-25','2017-10-31','Y'),(6,6,750000,929000,825000,129000,750000,'',0,8,100000,'2017-04-25','2017-10-31','Y'),(7,7,490000,579000,540000,139000,490000,'',0,4,110000,'2017-04-25','2017-10-31','Y'),(8,8,3150000,3539000,3300000,389000,3150000,'',0,9,350000,'2017-04-25','2017-10-31','Y'),(9,9,1690000,1839000,1770000,219000,1690000,'',0,9,180000,'2017-04-25','2017-10-31','Y'),(10,10,1890000,1980000,2069000,269000,1890000,'',0,9,200000,'2017-04-25','2017-10-31','Y'),(11,11,1400000,1584000,1500000,189000,1400000,'',0,9,155000,'2017-04-25','2017-10-31','Y'),(12,12,1200000,1200000,1200000,150000,1200000,'',0,7,150000,'2017-04-25','2017-10-31','Y'),(13,13,1950000,2010000,2010000,249000,1950000,'',0,9,200000,'2017-04-25','2017-10-31','Y'),(14,14,1800000,1939000,1845000,229000,1800000,'',0,9,190000,'2017-04-25','2017-10-31','Y'),(15,15,1950000,2049000,2010000,249000,1950000,'',0,9,200000,'2017-04-25','2017-10-31','Y');
...
insert  into `kas`(`id`,`kodekas`,`kodekasmanual`,`tanggal`,`total`) values (1,'KO2908170001','-','2017-08-29',450000);
...
insert  into `kas_besar_detail_temp`(`id`,`kodekas`,`kodekasmanual`,`tanggal`,`total`,`jeniskas`,`uraian`,`kodeakun`) values (1,'KA0908170001','-','2017-04-08',129000,'Masuk','UM Bu Mimin BP010817001','1112'),(2,'KA0908170001','-','2017-05-17',100000,'Masuk','Angsuran 1 Bu Mimin','1112'),(3,'KA0908170001','-','2017-06-07',100000,'Masuk','Angsuran 2 Bu Mimin','1112');
...
insert  into `kasdetail`(`id`,`kodekas`,`kodekasmanual`,`tanggal`,`total`,`jeniskas`,`uraian`,`kodeakun`) values (1,'KO2908170001','-','2017-07-01',450000,'Masuk','Supply Kas Pusat ke Kas Opr','1112');
...
insert  into `komisisales`(`id`,`kodebp`,`idsales`,`idpesanan`,`totaljual`,`komisibp`,`komisia1`,`komisilunas`,`komisitunai`,`komisibprupiah`,`komisia1rupiah`,`komisilunasrupiah`,`komisitunasirupiah`,`statuskomisibp`,`statuskomisia1`,`statuskomisilunas`,`statuskomisitunasi`,`statusbereskomisi`,`totalkomisi`) values (1,'BP010817001',6,1,929000,1.0764262648008611,0,0,0,10000,0,0,0,'2017-08-09',NULL,NULL,NULL,'belum',10000);
...
insert  into `pelanggan`(`idpelanggan`,`mankodepelanggan`,`namapelanggan`,`alamat`,`telepon`) values (1,'','Bu Supriyati','Jl Wonodri Kopen Barat III RT 4 / 11 Semarang',''),(2,'','Pak Ratno','Jl Wonodri Kopen Barat III Rt 4 / 11 Semarang','085715173117'),(3,'','Bu Nur Hidayat','Jl Wonodri Kopen Barat III Rt 4 / 11 Semarang',''),(4,'','Bu Lia','Asrama Brimob lantai II / 5 Banyumanik','082227116380'),(5,'','Bu Guntoro','Perum Bukit Jatisari blok A10	','081325668326'),(6,'','Bu Dian','Borobudur V Rt 3 Rw 12 Kembang arum','085290817702'),(7,'','Bu Mimin','MA Al Ashor','081575098081'),(8,'','Bu Mimin','MA Al Ashor','081575098081');
...
insert  into `sales`(`idsales`,`namasales`,`alamat`,`telepon`) values (1,'Ning','Semarang','085727682969'),(2,'Lenny','Semarang	','085701272252'),(3,'Tuti','Semarang','082133288862'),(4,'Indri','Semarang','081329231998'),(5,'Tressye','Semarang','081326072429'),(6,'Tyas','Semarang','081329648896'),(7,'Ari','Semarang','081327748587'),(8,'Yayuk','Semarang','085866299171'),(9,'Anik','Semarang','081805880599'),(10,'Wiwid','Semarang','');
...
insert  into `urutangsuran`(`idurut`,`nourutangsuran`) values (1,'KA0908170001');
...
insert  into `urutkas`(`idurut`,`nourutkas`) values (6,'KO2908170001');
...
insert  into `urutpesnan`(`idurut`,`nourutpesanan`) values (1,'BP010817001');
